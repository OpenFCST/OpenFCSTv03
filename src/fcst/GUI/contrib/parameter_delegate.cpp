// ---------------------------------------------------------------------
// $Id: parameter_delegate.cpp 31527 2013-11-03 09:58:45Z maier $
//
      ...
      if (index.column() == value_column)
        {
          QString pattern_description = index.data(Qt::StatusTipRole).toString();	// load pattern description
											// stored in the StatusLine
          QRegExp  rx_string("\\b(Anything|MultipleSelection|List|Map)\\b"),            //Modified by Philip Wardlaw Oct/2014
