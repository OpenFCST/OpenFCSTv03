...
void WaterAgglomerateTest::test02CurrentDerivative(){
    ...
    double expDCurrentDO2 = 4852.50;     double diffDCurrentDO2    = expDCurrentDO2*0.05;
    double expDCurrentPhi_m = 15445.68;  double diffDCurrentPhi_m  = expDCurrentPhi_m*0.05;
    double expDCurrentPhi_s = -15445.68;  double diffDCurrentPhi_s  = -expDCurrentPhi_s*0.05; //must be positive
